...
Все 34 пункта дорожной карты реализованы + 20 итераций улучшений + критическое исправление экономики. 96 юнит-тестов. Баланс оттюнен.

## Commands

- `cargo check` — быстрая проверка типов (host target)
- `cargo test` — 96 юнит-тестов
