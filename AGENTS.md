...
Все 34 пункта дорожной карты реализованы + 20 итераций улучшений. 94 юнит-теста. Баланс оттюнен.
...
- **Клавиатура**: Escape — отмена/снятие выделения, [ / ] — размер шрифта HUD